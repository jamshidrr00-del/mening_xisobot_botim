...
async def process_income(message: types.Message, state: FSMContext):
    # Barcha turdagi probellarni (jumladan Telegram'dagi yashirin probellarni ham) tozalaymiz
...
async def process_expense(message: types.Message):
    # Agar boshqa komandalar kelsa, ularni o'tkazib yuborish
    ...
    for line in lines:
        ...
        if match:
            ...
            # Narx ichidagi barcha turdagi probellarni tozalash
