...
    await message.answer("💰 Daromad summasini kiriting (masalan: `15000000` yoki `15 000 000`):", parse_mode="Markdown")
...
# --- XARAJAT KIRITISH (2 xil usul: Interaktiv FSM va Erkin matn) ---
...
    await message.answer("💳 Xarajat summasini kiriting:", parse_mode="Markdown")
